...
return function(context)
	...
	local function installHook()
		...
		local callback = function(self, ...)
			...
			-- ShootVFXEvent is always emitted for a native shot, even when the native
			-- client did not send StrokeEvent. That makes it the reliable shot boundary.
			local decision = getDecision()
			if decision then
	...
	SilentAim = context:CreateModule({
		...
		Tooltip = 'Silent targeting for aaaaa'
	})
