...
local reloadenv = {}
getgenv = function() return reloadenv end
local reloadctx = {
	state = 'loaded',
	events = {},
	mods = {},
	...
	config = {
		...
		unwatch = function() return true end
	},
	vapeapi = {
...
reloadenv.VapeTweaker = reloadctx
assert(loadfile('src/core/runtime.lua'))()(reloadctx)
assert(reloadctx:unload('reload'))
assert(reloadctx.savefailed and reloadctx.state == 'unloaded')
assert(reloadenv.VapeTweaker == nil)
